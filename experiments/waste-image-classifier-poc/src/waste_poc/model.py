...
def checkpoint_payload(model, optimizer, *, epoch: int, config: dict, class_names: list[str], manifest_hash: str, source_commit: str, run_id: str, training_mode: str, metrics: dict) -> dict:
    return {
        ...
        "normalization": "torchvision EfficientNet_B0_Weights.DEFAULT",
